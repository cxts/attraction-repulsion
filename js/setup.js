...
/**
* @description clear the canvas from  (x,y) to (width, height) and cover it with an alpha if arg given
*
...
* @param {NUMBER} alpha [optional]: value in range [0,1], default 0
* @return {VOID}
*
**/
...
/**
* @description stop the animation and restart on pressing "p" or space key
*
...
document.onkeydown = function(event) {
    if(event.key == "p" || event.key == " ") {
        paused = !paused; // invert the clicked value
        if(!paused) {
